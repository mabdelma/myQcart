        ...
        <div className="bg-white rounded-lg shadow-xl">
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900">Order #{order.id.slice(0, 8)}</h3>
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <div className="mt-1 flex items-center">
                          ...
                          <span className="text-sm text-gray-500">${(item.unitPrice * item.quantity).toFixed(2)}</span>
                        </div>
                      </div>
                    </div>
                    {item.notes && (
                      <div className="mt-2 flex items-start space-x-2 bg-amber-50 p-3 rounded-md">
                        ...
                        <div>
                          <div className="text-sm font-medium text-amber-900 mb-1">Special Instructions</div>
